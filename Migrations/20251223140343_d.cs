    ...
    public partial class d : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", 0, "676767d0-99a5-4159-a0ab-ac3c5df98518", 91234567, "admin@localhost.com", true, false, null, "Admin", "ADMIN@LOCALHOST.COM", "ADMIN@LOCALHOST.COM", "AQAAAAIAAYagAAAAEGRi2jqzy6qyU7OCFaSz4BtvSBHRdXIp7w7AH/07hO5Yje8gRy+3hu2BnF3XUwCLCA==", null, false, "5b62f25f-4aff-40bd-b28f-9c149c42bdf8", false, "admin@localhost.com" },
                    { "2", 0, "79713a76-7e6c-4137-9c42-d9c44348e662", 91234568, "user@localhost.com", true, false, null, "User", "USER@LOCALHOST.COM", "USER@LOCALHOST.COM", "AQAAAAIAAYagAAAAEOgGrQ4VwTL9aQjP15DqBattCmEUn7FqZRjxwyK4xYYnJSf8rJ8ISRc8OXvto1VX2A==", null, false, "302640a3-5062-480c-b027-57add4d44749", false, "user@localhost.com" },
                    { "3", 0, "1569b036-0168-4a15-8fa5-ad843dbc54ef", 91234560, "restaurantstaff@localhost.com", true, false, null, "RestaurantStaff", "RESTAURANTSTAFF@LOCALHOST.COM", "RESTAURANTSTAFF@LOCALHOST.COM", "AQAAAAIAAYagAAAAEGXHbVHw2rV+wqXI2V11c11qfryId0aBfsVuhrn+6M/PADFFpeNqBeFujJt5DhCcJg==", null, false, "b57eb7b5-b4e8-431d-8b42-7a51ba50ffbb", false, "restaurantstaff@localhost.com" }
                });

            migrationBuilder.InsertData(
                table: "DinesaurUser",
                columns: new[] { "Id", "Contact", "DinesaurUserID", "DinesaurUserName", "Email" },
                values: new object[] { 1, 91234568, "2", "User User", "user@localhost.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 12, 23, 22, 3, 43, 48, DateTimeKind.Local).AddTicks(7516), "Orchard", "Null", 1, 1, 1 },
                    { 2, new DateTime(2025, 12, 23, 22, 3, 43, 48, DateTimeKind.Local).AddTicks(7528), "Novena", "Null", 2, 2, 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2025, 12, 23, 22, 3, 43, 48, DateTimeKind.Local).AddTicks(7653), "Bad", "Orchard", 2.5, 1, 1, "Bad" });
